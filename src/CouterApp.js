...
export default function CouterApp({ setCount}) {
  ...
  <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2zm10-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1"/>
       ...
       <span style={{marginLeft:"10px" ,padding:"0", margin:"0"}} onClick={() => setCount((count) => count - 1)}><svg xmlns="http://www.w3.org/2000/svg" width="66" height="66" fill="black" class="bi bi-file-minus" viewBox="0 0 16 16">
